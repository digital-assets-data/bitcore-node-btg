...
Bitcoin.prototype._loadSpawnConfiguration = function(node) {
  ...
  $.checkArgument(this.options.spawn.configPath, 'Please specify "spawn.configPath" in bitcoind config options');
  ...
  var configPath = path.resolve(spawnOptions.configPath);
